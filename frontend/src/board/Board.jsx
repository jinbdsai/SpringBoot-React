    ...
    <div className="board-page">
      <header className="board-page__header">
        <div className="board-page__header-row">
          <div>
            <h1 className="board-page__title" onClick={goList} role="button">
              💬 자유 게시판
            </h1>
          ...
          {authChecked && (
            <div className="board-page__user">
              {currentUser ? (
                <>
                  <span className="board-page__welcome">
      ...
      <main className="board-page__main">
        {view === 'list' && (
          <PostList posts={posts} loading={loading} onSelect={goDetail} onWrite={goWrite} />
        )}
